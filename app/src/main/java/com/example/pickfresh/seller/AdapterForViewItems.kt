...
class AdapterForViewItems(val context: Context, val data: ArrayList<Items>, val string: String) :
    RecyclerView.Adapter<AdapterForViewItems.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        with(holder.item) {
            ...
            if ("not change" == string) {
                details2.text = HtmlCompat.fromHtml(
                    "<b>Name : </b>${k.itemname}<br></br><b>Price : </b>₹${k.price}/-<br></br><b>Status : </b>${k.status}<br></br>",
