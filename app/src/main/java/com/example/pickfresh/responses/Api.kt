...
interface Api {
    ...
    suspend fun addRental(
        ...
        @Field("rentalType") rentalType: String,
        @Field("rentalRupees") rentalRupees: String,
        @Field("dateOn") dateOn: String,
        @Field("rentalDes") rentalDes: String,
        @Field("rentalMobile") rentalMobile: String,
    ): Response<CommonReponse>
    ...
    suspend fun getMyOrders(
        @Field("id") id: String,
        @Field("condition") condition: String,
    ): Response<FertiProductResponse>

    @FormUrlEncoded
    @POST("getdata.php")
    suspend fun getUsersOrders(
        @Field("condition") condition: String = "viewPartOfUserOrders",
    ):
            Response<UserResponsesForIt>

    @FormUrlEncoded
    @POST("updatefun.php")
    suspend fun updateOrderView(
        @Field("condition") condition: String = "updatePointOrder",
        @Field("id") id: String,
        @Field("state") state: String
    ): Response<CommonReponse>
    ...
    suspend fun addScheme(
        ...
        @Field("schemeDes")schemeDes:String,
        @Field("dateUp")dateUp:String,
    ):Response<CommonReponse>

    @FormUrlEncoded
    @POST("getdata.php")
    suspend fun getMySuggestions(
        @Field("condition")condition:String="getSchemes"
    ): Response<ResponseOfSchemes>
